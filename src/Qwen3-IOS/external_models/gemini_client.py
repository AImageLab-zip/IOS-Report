"""
Google Gemini API client for Gemini3 evaluation.
"""
...
class GeminiModel(BaseExternalModel):
    """
    Google Gemini3 client for intraoral photo analysis.
    """
    
    def __init__(
        self,
        api_key: Optional[str] = None,
        model_name: str = "gemini-3.0-pro-vision",  # Update with actual model name
    ...
    def generate(
        ...
        """
        Generate description using Google Gemini3.
