"""
OpenAI API client for GPT5.2 evaluation.
"""
...
class OpenAIModel(BaseExternalModel):
    """
    OpenAI GPT5.2 client for intraoral photo analysis.
    """
    
    def __init__(
        self,
        api_key: Optional[str] = None,
        model_name: str = "gpt-5.2-vision",  # Update with actual model name when available
    ...
    def generate(
        ...
        """
        Generate description using OpenAI GPT5.2.
