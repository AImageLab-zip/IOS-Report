...
def get_args():
    ...
    args.wandb_path = os.path.join('./experiments', Path(args.config).stem, Path(args.config).parent.stem,'wandb' ,args.exp_name)
...
def create_experiment_dir(args):
    ...
    if not os.path.exists(args.wandb_path):
        os.makedirs(args.wandb_path)
        print('Create wandb path successfully at %s' % args.wandb_path)
